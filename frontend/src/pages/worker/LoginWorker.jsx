      ...
      <div className="form-panel" style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '3rem 6rem', backgroundColor: C.bg }}>
        <div style={{ margin: '0 auto', width: '100%', maxWidth: '28rem' }}>
          ...
          <div style={{ marginBottom: '2.5rem' }}>
            ...
            <p style={{ fontSize: '1rem', color: C.mutedColor, margin: 0 }}>Bienvenue ! Connectez-vous à votre espace professionnel.</p>
          </div>

          {/* Toggle */}
          <div style={{ padding: '0.25rem', backgroundColor: C.toggleBg, borderRadius: '0.75rem', display: 'flex', marginBottom: '1.5rem' }}>
            <Link to="/login/client" style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', padding: '0.75rem 1rem', borderRadius: '0.5rem', color: C.mutedColor, fontWeight: 600, fontSize: '0.875rem', textDecoration: 'none', transition: 'color 0.15s' }}
          ...
          <p style={{ marginTop: '2.5rem', textAlign: 'center', fontSize: '0.875rem', color: C.mutedColor }}>
            ...
            <Link to="/register/worker" style={{ color: C.copper, fontWeight: 700, textDecoration: 'none', marginLeft: '0.25rem' }}>S'inscrire ici</Link>
          </p>
        </div>
      </div>
