...
const steps = [
  {
    ...
    desc: 'Décrivez votre besoin, votre budget et votre ville. C\'est gratuit et rapide.',
  },
  {
    num: '02',
    icon: 'person_search',
    title: 'Recevez des propositions',
    desc: 'Des professionnels vérifiés de votre région vous contactent directement.',
  },
  {
    num: '03',
    icon: 'handshake',
    title: 'Choisissez & travaillez',
    desc: 'Comparez les profils, chattez et choisissez le professionnel idéal.',
  },
  {
    num: '04',
    icon: 'star',
    title: 'Notez le service',
    desc: 'Partagez votre expérience pour aider la communauté.',
  },
];
...
const testimonials = [
  {
    name: 'Sophie L.',
    role: 'Cliente',
    text: 'J\'ai trouvé un plombier excellent en moins de 2 heures. Service impeccable, je recommande vivement !',
    stars: 5,
  },
  {
    name: 'Karim B.',
    role: 'Électricien professionnel',
    text: 'Grâce à Bricolage Connect, j\'ai multiplié mes clients par 3 en un mois. Une plateforme vraiment professionnelle.',
    stars: 5,
  },
  {
    name: 'Marie D.',
    role: 'Cliente',
    text: 'Rapide, fiable et transparent. Le chat avec le professionnel avant le rendez-vous est très rassurant.',
    stars: 5,
  },
];
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', fontFamily: 'Inter, sans-serif' }}>
      ...
      <style>{`
        ...
        /* Fix Peinture : centré dans toutes les grilles à 2 colonnes */
        @media (max-width: 768px) {
          .home-categories-grid > *:last-child {
            grid-column: 1 / -1;
        ...
        /* ══════════════════════════════════════════
           iPad Pro / Nest Hub / Surface Pro 7 (≤ 1024px)
           1024×1366, 1024×600, 912×1368
        ══════════════════════════════════════════ */
        @media (max-width: 1024px) {
          ...
          .home-categories-grid    { grid-template-columns: repeat(3, 1fr); --cols: 3; }
        ...
        /* ══════════════════════════════════════════
           Asus Zenbook Fold / iPad Air (≤ 853px)
           853×1280, 820×1180
        ══════════════════════════════════════════ */
        ...
        ══════════════════════════════════════════ */
        @media (max-width: 768px) {
          .home-header           { padding: 0.75rem 1.5rem; flex-wrap: wrap; gap: 0.75rem; }
          .home-nav              { display: none; }
          .home-nav-btn-group a  { min-width: unset !important; padding: 0 0.9rem !important; height: 40px !important; font-size: 0.82rem !important; }
          ...
          .home-categories-grid    { grid-template-columns: repeat(2, 1fr); gap: 1rem !important; --cols: 2; }
        ...
        @media (max-width: 540px) {
          .home-header           { padding: 0.75rem 1.25rem; }
        ...
        /* ══════════════════════════════════════════
           Téléphones modernes — iPhone 14 Pro Max,
           Pixel 7, Samsung S20 Ultra, A51/71 (≤ 430px)
        ══════════════════════════════════════════ */
        @media (max-width: 430px) {
          .home-hero-title       { font-size: 1.875rem !important; }
          .home-nav-btn-group a  { padding: 0 0.75rem !important; height: 38px !important; font-size: 0.78rem !important; }
          .home-categories-grid  { grid-template-columns: repeat(2, 1fr) !important; gap: 0.875rem !important; --cols: 2; }
          .home-steps-grid       { grid-template-columns: 1fr !important; }
        ...
        @media (max-width: 375px) {
          .home-header           { padding: 0.65rem 1rem; }
          .home-hero             { padding: 2.5rem 1rem !important; }
          .home-hero-title       { font-size: 1.65rem !important; }
          .home-nav-btn-group a  { padding: 0 0.6rem !important; height: 36px !important; font-size: 0.75rem !important; }
          .home-categories-grid  { grid-template-columns: repeat(2, 1fr) !important; gap: 0.75rem !important; --cols: 2; }
        ...
        @media (max-width: 344px) {
          ...
          .home-nav-btn-group    { gap: 0.35rem; }
          .home-nav-btn-group a  { padding: 0 0.5rem !important; height: 34px !important; font-size: 0.72rem !important; }
          .home-categories-grid  { grid-template-columns: 1fr 1fr !important; gap: 0.625rem !important; --cols: 2; }
      ...
      <section className="home-hero" style={{
        backgroundColor: '#2F3E34', color: '#F5F2EC',
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', maxWidth: 540 }}>
          ...
          <div className="home-hero-cta" style={{ display: 'flex', gap: '1rem', paddingTop: '1rem', flexWrap: 'wrap' }}>
            <Link to="/login/client" style={{
              padding: '1rem 2rem', backgroundColor: '#b87332', color: 'white',
              borderRadius: 12, fontWeight: 700, fontSize: '1.1rem', textDecoration: 'none',
              boxShadow: '0 8px 24px rgba(184,115,50,0.3)', transition: 'all 0.2s',
            }}
            ...
            <Link to="/login/worker" style={{
              padding: '1rem 2rem', backgroundColor: 'transparent', color: 'white',
              borderRadius: 12, fontWeight: 700, fontSize: '1.1rem', textDecoration: 'none',
        ...
        <div style={{ position: 'relative', borderRadius: 20, overflow: 'hidden', boxShadow: '0 24px 64px rgba(0,0,0,0.3)' }}>
          ...
          <div style={{
            ...
            backdropFilter: 'blur(12px)', backgroundColor: 'rgba(47,62,52,0.7)',
            padding: '1rem 1.25rem', borderRadius: 12, border: '1px solid rgba(255,255,255,0.1)',
            ...
            <span style={{ backgroundColor: 'rgba(184,115,50,0.9)', fontSize: '0.75rem', fontWeight: 700, padding: '4px 12px', borderRadius: 999 }}>
              PRO VÉRIFIÉ
            </span>
          </div>
        </div>
      ...
      <section id="services" className="home-categories-section" style={{ backgroundColor: '#E8E3D9' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div className="home-categories-grid" style={{ display: 'grid', gap: '1.5rem', '--cols': 5 }}>
            {categories.map((cat, i) => (
              <div key={i}
                ...
                <div style={{ width: 64, height: 64, borderRadius: '50%', backgroundColor: 'rgba(184,115,50,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#b87332', transition: 'all 0.3s' }}>
      ...
      {/* ════════ COMMENT ÇA MARCHE — id="comment-ca-marche" ✅ ════════ */}
          ...
          <div className="home-steps-grid" style={{ display: 'grid', gap: '2rem' }}>
            {steps.map((step, i) => (
              <div key={i} style={{ textAlign: 'center', padding: '2rem 1.5rem', borderRadius: 16, backgroundColor: '#f8fafc', border: '1px solid #f1f5f9', position: 'relative' }}>
                <div style={{ position: 'absolute', top: -16, left: '50%', transform: 'translateX(-50%)', backgroundColor: '#b87332', color: 'white', width: 36, height: 36, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 800, fontSize: '0.85rem' }}>
                  {step.num}
                </div>
              ...
              <div key={i} style={{ backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 16, padding: '2rem', border: '1px solid rgba(255,255,255,0.1)' }}>
                <div style={{ marginBottom: '1rem' }}>
                  {'★'.repeat(t.stars).split('').map((s, j) => (
                    <span key={j} style={{ color: '#b87332', fontSize: '1.2rem' }}>★</span>
                  ))}
                </div>
                <p style={{ color: 'rgba(245,242,236,0.85)', lineHeight: 1.7, margin: '0 0 1.5rem 0', fontStyle: 'italic' }}>
                  "{t.text}"
                </p>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                  <div style={{ width: 44, height: 44, borderRadius: '50%', backgroundColor: '#b87332', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontWeight: 700, fontSize: '1.1rem' }}>
                    {t.name[0]}
                  </div>
                  <div>
      ...
      <section id="tarifs" className="home-cta-section" style={{ backgroundColor: '#E8E3D9', textAlign: 'center' }}>
        <div style={{ maxWidth: 700, margin: '0 auto' }}>
          <h2 style={{ fontSize: '2.5rem', fontWeight: 800, color: '#1e293b', margin: '0 0 1rem 0' }}>
            Prêt à démarrer votre projet ?
          </h2>
          <p style={{ color: '#64748b', fontSize: '1.1rem', marginBottom: '2.5rem', lineHeight: 1.7 }}>
            Rejoignez des milliers de clients satisfaits et trouvez le professionnel idéal pour votre projet.
          </p>
          <div className="home-cta-btns" style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link to="/register/client" style={{
              padding: '1rem 2.5rem', backgroundColor: '#b87332', color: 'white',
              borderRadius: 12, fontWeight: 700, fontSize: '1rem', textDecoration: 'none',
              boxShadow: '0 8px 24px rgba(184,115,50,0.3)',
            }}>
              Je cherche un professionnel
            </Link>
            <Link to="/register/worker" style={{
              padding: '1rem 2.5rem', backgroundColor: '#2F3E34', color: 'white',
              borderRadius: 12, fontWeight: 700, fontSize: '1rem', textDecoration: 'none',
            }}>
      ...
      {/* ════════ FOOTER ════════ */}
      <footer style={{
        backgroundColor: '#1e2b23', borderTop: '1px solid rgba(255,255,255,0.05)',
        color: '#94a3b8',
      }}>
